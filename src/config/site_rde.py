...
URLS = {
    ...
    "api": {
        ...
        "data": f"{URL_RDE_API_BASE}data?filter%5Bdataset.id%5D={{id}}&sort=-created&page%5Boffset%5D=0&page%5Blimit%5D=100&include=owner%2Csample%2CthumbnailFile%2Cfiles",
