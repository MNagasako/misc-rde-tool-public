...
class LightTheme:
    ...
    COLORS = {
        ...
        # Group1: ログイン
        ThemeKey.MENU_GROUP1_INACTIVE_BACKGROUND: "#43a047",  # Green 600
        ThemeKey.MENU_GROUP1_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP1_HOVER_BACKGROUND: "#388e3c",  # Green 700
        ThemeKey.MENU_GROUP1_ACTIVE_BACKGROUND: "#2e7d32",  # Green 800
        ThemeKey.MENU_GROUP1_ACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP1_ACTIVE_HOVER_BACKGROUND: "#1b5e20",  # Green 900

        # Group2: RDE関係
        ThemeKey.MENU_GROUP2_INACTIVE_BACKGROUND: "#1e88e5",  # Blue 600
        ThemeKey.MENU_GROUP2_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP2_HOVER_BACKGROUND: "#1976d2",  # Blue 700
        ThemeKey.MENU_GROUP2_ACTIVE_BACKGROUND: "#1565c0",  # Blue 800
        ThemeKey.MENU_GROUP2_ACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP2_ACTIVE_HOVER_BACKGROUND: "#0d47a1",  # Blue 900

        # Group3: RDE準備（Group2に近い）
        ThemeKey.MENU_GROUP3_INACTIVE_BACKGROUND: "#3949ab",  # Indigo 600
        ThemeKey.MENU_GROUP3_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP3_HOVER_BACKGROUND: "#303f9f",  # Indigo 700
        ThemeKey.MENU_GROUP3_ACTIVE_BACKGROUND: "#283593",  # Indigo 800
        ThemeKey.MENU_GROUP3_ACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP3_ACTIVE_HOVER_BACKGROUND: "#1a237e",  # Indigo 900

        # Group4: データポータル関係
        ThemeKey.MENU_GROUP4_INACTIVE_BACKGROUND: "#00897b",  # Teal 600
        ThemeKey.MENU_GROUP4_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP4_HOVER_BACKGROUND: "#00796b",  # Teal 700
        ThemeKey.MENU_GROUP4_ACTIVE_BACKGROUND: "#00695c",  # Teal 800
        ThemeKey.MENU_GROUP4_ACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP4_ACTIVE_HOVER_BACKGROUND: "#004d40",  # Teal 900

        # Group5: AI関係
        ThemeKey.MENU_GROUP5_INACTIVE_BACKGROUND: "#8e24aa",  # Purple 600
        ThemeKey.MENU_GROUP5_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP5_HOVER_BACKGROUND: "#7b1fa2",  # Purple 700
        ThemeKey.MENU_GROUP5_ACTIVE_BACKGROUND: "#6a1b9a",  # Purple 800
        ThemeKey.MENU_GROUP5_ACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP5_ACTIVE_HOVER_BACKGROUND: "#4a148c",  # Purple 900

        # Group6: 設定関係
        ThemeKey.MENU_GROUP6_INACTIVE_BACKGROUND: "#607d8b",  # Blue Grey 500
        ThemeKey.MENU_GROUP6_INACTIVE_TEXT: "#ffffff",
        ThemeKey.MENU_GROUP6_HOVER_BACKGROUND: "#546e7a",  # Blue Grey 600
