...
_MAPPING = {
    ...
    'basicinfo_export': (
        ThemeKey.BUTTON_BASICINFO_EXPORT_BACKGROUND,
        ThemeKey.BUTTON_BASICINFO_EXPORT_TEXT,
        ThemeKey.BUTTON_BASICINFO_EXPORT_BACKGROUND_HOVER,
        ThemeKey.BUTTON_BASICINFO_EXPORT_BACKGROUND_PRESSED,
        ThemeKey.BUTTON_BASICINFO_EXPORT_BORDER,
    ),
    'basicinfo_folder': (
        ThemeKey.BUTTON_BASICINFO_FOLDER_BACKGROUND,
        ThemeKey.BUTTON_BASICINFO_FOLDER_TEXT,
        ThemeKey.BUTTON_BASICINFO_FOLDER_BACKGROUND_HOVER,
        ThemeKey.BUTTON_BASICINFO_FOLDER_BACKGROUND_PRESSED,
        ThemeKey.BUTTON_BASICINFO_FOLDER_BORDER,
    ),
}
