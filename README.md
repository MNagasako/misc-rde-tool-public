# ARIM RDE Tool v1.17.3

## 最新バージョンの更新情報（v1.17.2 2025-09-16）

## 最新バージョンの更新情報（v1.17.3 2025-09-16）

### 新機能・主な変更点
- 【AI機能拡張】AIプロバイダ・モデル定義の拡充、ローカルLLM対応強化
- 【UI改善】AI設定ファイルの説明追加、AIプロンプトカスタマイズ手順明記
- 【安定性向上】AI連携時のエラーハンドリング強化・タイムアウト設定追加
- 【ドキュメント更新】READMEのAI設定・バイナリ化手順・既知の不具合を最新化
