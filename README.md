...
**ARIM事業 RDE→ARIMデータポータル移行ツール v2.1.16** のバイナリ配布およびドキュメント公開用リポジトリです。
...
**2025-12-04 最新リリース**: バージョン2.1.16（説明文品質チェック機能・フォント可読性向上）

### v2.1.16 の主な改善
 
- データセット修正タブ: 説明文の「AI CHECK」ボタンを追加
  - AI品質チェック機能により説明文の妥当性を簡易評価（合格/微修正推奨/要修正/判定不能）
  - 非同期実行・タイムアウト・リトライ対応で堅牢性向上
- AI CHECK 結果表示ダイアログのフォントサイズ改善
  - 全体的に拡大されユーザビリティが向上
