...
Windows向け配布版 v2.5.47 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.47 では、一覧の CSV / XLSX 出力と Excel 読み込み周辺を整理し、依存関係を見直しながら既存の出力・取り込み機能を継続して利用できるよう整えています。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.47.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.47.md](docs/RELEASE_NOTES_v2.5.47.md)
