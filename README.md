...
**バージョン: v1.12.5（2025-08-18）**
---

## v1.12.5 変更点（要約）
- AI機能の包括的強化（モデル名・応答時間・レスポンス情報表示）
- レスポンス情報管理システム実装（成功・失敗時の詳細情報追跡）
- GPT-5モデル対応・Geminiデフォルトプロバイダ設定
- CLI版AI機能テストツール追加（PowerShell/Batch自動実行スクリプト）
- マルチプロバイダ対応（OpenAI/Gemini/Local LLM自動テスト）
- バイナリ作成手順・PyInstallerコマンド例追加
- v1.12.4までの修正・クリーンアップ
---
## 配布用ディレクトリ構成
...
- v1.12.0（2025-08-08）: リビジョンアップ（内部更新のみ）
