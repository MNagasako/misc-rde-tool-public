...
Windows向け配布版 v2.5.55 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.55 では、データポータルの managed CSV 取得フロー変更に対応し、新旧ヘッダの互換を維持しながら一覧表示を整理しています。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.55.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.55.md](docs/RELEASE_NOTES_v2.5.55.md)
