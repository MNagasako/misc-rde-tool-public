...
Windows向け配布版 v2.5.48 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.48 では、起動直後や重い画面の初期表示を見直し、設定・AI・データ取得系の画面をより操作しやすくしています。新規開設2の既存データセット読込も状態表示付きで進めやすくなりました。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.48.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.48.md](docs/RELEASE_NOTES_v2.5.48.md)
