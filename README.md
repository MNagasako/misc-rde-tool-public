...
Windows向け配布版 v2.5.53 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.53 では、UI表示のリセット追加、データセット関連画面の親子関係と進捗表示条件の整理、起動時表示の安定化を反映しています。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.53.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.53.md](docs/RELEASE_NOTES_v2.5.53.md)
