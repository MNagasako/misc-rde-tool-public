...
**最新版: [v1.13.2](https://github.com/MNagasako/misc-rde-access/releases/tag/v1.13.2)（2025-08-24）**

**安定版: [v1.13.1](https://github.com/MNagasako/misc-rde-tool-public/releases/tag/v1.13.1)（2025-08-22）**

---

## v1.13.2 変更点（要約）
- **リファクタリング継続**: フォーム機能分離・UI責務明確化による保守性向上
- **コードベース整備**: 重複コード削除・品質改善・アーキテクチャ強化継続
- **ドキュメント更新**: 開発進捗反映・技術仕様書最新化
...
### フォーム機能分離・アーキテクチャ改善
- **責務分離完了**: UIControllerForms分離によるフォーム機能専門化
- **コードベース整備**: 重複コード削除616行（15.4%削減）完了
- **保守性向上**: 分離されたクラス構造による開発・保守効率化

### 前バージョン主要機能
- **v1.13.1**: 継続的メンテナンス・品質向上・ドキュメント整備
- **v1.13.0**: サブグループUI改善・パス管理システム大幅強化
- **v1.12.6**: データセット登録・開設UIバグ修正
...
### ダウンロード
- **安定版推奨**: [v1.13.1](https://github.com/MNagasako/misc-rde-tool-public/releases/tag/v1.13.1) - 実運用での使用に推奨
- **最新版**: [v1.13.2](https://github.com/MNagasako/misc-rde-access/releases/tag/v1.13.2) - 新機能・改善を含む最新版
