...
---
**バージョン: v1.12.3（2025-08-17）**
---



## v1.12.3 変更点（要約）
- 不要ファイル・キャッシュ削除によるクリーンアップ
- デバッグコード除去・パフォーマンス最適化
- UI改善（メニューボタン表示位置統一化、閉じるボタン位置固定、色分けによる選択状態表示）
- v1.12.0以降のUI/UX大幅改善（拡大表示機能、キーボードショートカット、AIテスト画面最適化）
