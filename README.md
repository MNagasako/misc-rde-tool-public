...
| v1.18.5 | 2025-10-22 | （ここに変更内容を記載） |
| v1.18.4 | （未記載） | （リリースノート参照） |
...
| v1.17.8 | 2025-09-21 | 一括登録・サブグループ編集・AIテストの細かなバグ修正／データセット編集画面のUI調整・説明文明確化／ローカルLLM利用時のエラー通知強化・プロンプト選択UI改善／READMEのバージョン・機能説明・既知の不具合・ToDoを最新化 |
