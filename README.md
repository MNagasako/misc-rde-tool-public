...
Windows向け配布版 v2.5.56 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.56 では、AI が追加取得する STRUCTURED ファイルの保存先を temp / dataFiles / dataFilesAI から選べるようにし、既存キャッシュ再利用で再取得や保存先運用を整理しています。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.56.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.56.md](docs/RELEASE_NOTES_v2.5.56.md)
