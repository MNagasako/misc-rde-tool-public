...
Windows向け配布版 v2.5.57 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.57 では、Basic Info の samples 取得で既存互換を維持しつつ直接取得ルートを追加し、ALL 実行と単体実行の導線統合、進捗表示と診断性の改善を行いました。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.57.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.57.md](docs/RELEASE_NOTES_v2.5.57.md)
