...
> 重要：本リポジトリは配布専用リポジトリに移行しました。開発版における大幅な変更（PyQt5 → PySide6 移行、ライセンス変更、ソースコード非公開化）に伴い、今後はバイナリ配布を主とし、ソースコードの公開は行いません。利用方法は旧版（v1.x 系）とほぼ同様ですが、差分や破壊的変更があるため詳細は下記の v2.0.0 リリースノートを参照してください。

> **重要**: 本配布版（v1.20.0）は開発版リポジトリ（\rde）のバイナリビルド版です。使用方法の説明は旧バージョン（v1.19.x以前）を基に記載されており、v1.20.0の新機能（データポータル統合機能等）については部分的に記載が異なる場合があります。詳細は [RELEASE_NOTES_v1.20.0.md](docs/RELEASE_NOTES_v1.20.0.md) をご参照ください。
...
| v1.19.1 | 2025-10-31 | QWidgetサイズエラー修正・AI Test 2ボタン安定化・軽微な修正 |
| v1.19.0 | 2025-10-31 | ライブラリ更新・安定性向上・軽微な修正 |
| v1.18.5 | 2025-10-22 | 安定性向上・バージョン統一・既存機能堅牢性維持 |
| v1.18.4 | 2025-10-22 | API Token問題修正・403エラー解決 |
| v1.18.3 | 2025-10-06 | 軽微な修正・安定性向上 |
| v1.18.2 | 2025-10-06 | 軽微な修正・安定性向上 |
| v1.18.1 | 2025-10-03 | データセット説明欄にAIサジェスト機能を追加／軽微な修正・安定性向上 |
| v1.18.0 | 2025-10-02 | 新機能・改善点の記載（例：UI改善、バグ修正、パフォーマンス向上など）／軽微な修正・安定性向上 |
...
| v1.17.7 | 2025-09-19 | 軽微な修正・安定性向上                         |
| v1.17.6 | 2025-09-18 | ドキュメント整理・安定性向上・軽微な修正         |
...
* **データポータル統合機能（v1.20.0新機能）**：JSON書誌情報アップロード・画像一括アップロード・修正機能・ステータス管理
...
- PyQtのライセンス上の理由から将来的に **PySide** への移行を検討
