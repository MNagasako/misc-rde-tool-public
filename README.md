...
Windows向け配布版 v2.5.54 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.54 では、データセット修正画面の既定候補を再利用するキャッシュ改善と、設定画面からのキャッシュ確認・クリアを反映しています。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.54.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.54.md](docs/RELEASE_NOTES_v2.5.54.md)
