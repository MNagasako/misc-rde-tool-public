# ARIM RDE Tool v1.17.2

## 最新バージョンの更新情報（v1.17.2 2025-09-16）

### 新機能
- データ一括登録機能
  - ファイルセット定義
  - ファイルセット分割
  - ファイルパスフラット化・パスマッピング出力
- データセット機能追加
  - データエントリ（タイル）機能（検索・表示・リンク対応）

### 既知の不具合
- フォントサイズやウインドウサイズがしっかり追い込めていないため、画面サイズやアスペクト比によっては見えにくくなる場合があります。
...
- ドロップダウンUIの視認性改善
- isOpen・manager/dataOwners/applicant対応
- エラーハンドリング強化
