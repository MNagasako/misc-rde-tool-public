...
Windows向け配布版 v2.5.52 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.52 では、現行コードスナップショットに対する版数・配布物・ドキュメントの同期を行い、リリース整合性を更新しました。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.52.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.52.md](docs/RELEASE_NOTES_v2.5.52.md)
