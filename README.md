...
Windows向け配布版 v2.5.51 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.51 では、更新履歴タブを VERSION.txt ベースに整理し、サブグループ確認表示のユーザー名解決、既存データセット候補の非同期読込中の選択性、終了時停止ガードとデータポータル一覧のキャンセル経路を安定化しました。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.51.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.51.md](docs/RELEASE_NOTES_v2.5.51.md)
