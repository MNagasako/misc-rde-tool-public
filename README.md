...
Windows向け配布版 v2.5.50 のインストーラと利用者向けドキュメントを公開しています。
...
v2.5.50 では、主要画面の初回サイズと表示位置の復元を広げ、ログイン前後の表示の乱れを抑えつつ、データ取得2や一括取得（DP）の一覧操作を扱いやすくしました。

## 2) インストール方法

1. [Releases](https://github.com/MNagasako/misc-rde-tool-public/releases) から最新版インストーラを取得
2. arim_rde_tool_setup.2.5.50.exe を実行
3. 画面の案内に従ってインストール
...
- リリースノート: [docs/RELEASE_NOTES_v2.5.50.md](docs/RELEASE_NOTES_v2.5.50.md)
